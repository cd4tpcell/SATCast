...
def load_data(batchsize:int) -> tuple[DataLoader, DistributedSampler]:
    ...
    tfiles=files[0:19904]
    tfilesz=tfiles+tfiles[4636-884:4900-884]+tfiles[5126-884:5221-884]+tfiles[5306-884:5380-884]+tfiles[5420-884:5490-884]+tfiles[5516-884:5589-884]+tfiles[5646-884:5739-884]
    tfilesz=tfilesz+tfiles[6221-884:6305-884]+tfiles[6476-884:6589-884]+tfiles[6926-884:6984-884]+tfiles[9083-884:9188-884]+tfiles[10547-884:10601-884]+tfiles[10788-884:10983-884]+tfiles[11450-884:11945-884]+tfiles[14313-884:14437-884]
    tfilesz=tfilesz+tfiles[15880-884:16122-884]+tfiles[16601-884:16705-884]+tfiles[18340-884:18406-884]+tfiles[19713-884:19809-884-37]



    train_dataset = MyDataset(dir,tfilesz)
...
def demo_basic():
    ...
    maxepo=300
    optimizer = AdamW(ddp_model.parameters(), lr=5e-5, betas=(0.9, 0.999), eps=1e-08, weight_decay=0.01)
    ...
    for epoch in range(0,maxepo):
        ...
        if (epoch + 1) % 50 == 0:
            ...
            if local_rank == 0:
                ...
                model_checkpoint_path = 'satc14'+str(epoch)+'.pth'
                torch.save({
                    'epoch': epoch,
                    "ema": ema.state_dict(),
